                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('bank_name') is-invalid @enderror" name="bank_name">
                                    ...
                                    <option value="BPI" @if(old('bank_name', $customer->bank_name) == 'BPI')selected="selected"@endif>BPI</option>
                                    <option value="BDO" @if(old('bank_name', $customer->bank_name) == 'BDO')selected="selected"@endif>BDO</option>
                                    <option value="LANDBANK" @if(old('bank_name', $customer->bank_name) == 'LANDBANK')selected="selected"@endif>LANDBANK</option>
                                    <option value="PNB" @if(old('bank_name', $customer->bank_name) == 'PNB')selected="selected"@endif>PNB</option>
                                    <option value="RCBC" @if(old('bank_name', $customer->bank_name) == 'RCBC')selected="selected"@endif>RCBC</option>
                                </select>
                                @error('bank_name')
                                <div class="invalid-feedback">
                                    {{ $message }}
